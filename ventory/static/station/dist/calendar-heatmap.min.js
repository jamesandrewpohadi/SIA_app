    ...
    drawGlobalOverview: function() {
        ...
        calendarHeatmap.items.selectAll(".item-block-year").data(t).enter().append("rect").attr("class", "item item-block-year").attr("width", function() {
            ...
            if (!calendarHeatmap.in_transition) {
                ...
                calendarHeatmap.tooltip.html(e).style("left", s + "px").style("top", c + document.body.scrollTop + document.documentElement.scrollTop+ "px").transition().duration(calendarHeatmap.settings.transition_duration / 2).ease(d3.easeLinear).style("opacity", 1)
            }
    ...
    drawYearOverview: function() {
        ...
        calendarHeatmap.items.selectAll(".item-circle").remove(), calendarHeatmap.items.selectAll(".item-circle").data(t).enter().append("rect").attr("class", "item item-circle").style("opacity", 0).attr("x", function(a) {
            ...
            if (!calendarHeatmap.in_transition) {
                ...
                var t = "";
                t += '<div class="header"><strong>' + (a.total ? calendarHeatmap.formatTime(a.total) : "No item") + " tracked</strong></div>", t += "<div>on " + moment(a.date).format("dddd, MMM Do YYYY") + "</div><br>";
                ...
                calendarHeatmap.tooltip.html(t).style("left", r + "px").style("top", o +document.body.scrollTop + document.documentElement.scrollTop + "px").transition().duration(calendarHeatmap.settings.transition_duration / 2).ease(d3.easeLinear).style("opacity", 1)
            }
        }).on("mouseout", function() {
    ...
    drawMonthOverview: function() {
        ...
        o.selectAll(".item-block-rect").data(function(a) {
            ...
            if (!calendarHeatmap.in_transition) {
                ...
                calendarHeatmap.tooltip.html(t).style("left", n + "px").style("top", r +  document.body.scrollTop + document.documentElement.scrollTop + "px").transition().duration(calendarHeatmap.settings.transition_duration / 2).ease(d3.easeLinear).style("opacity", 1)
            }
        }).on("mouseout", function() {
            calendarHeatmap.in_transition || calendarHeatmap.hideTooltip()
        }).transition().delay(function() {
    ...
    drawWeekOverview: function() {
        ...
        o.selectAll(".item-block-rect").data(function(a) {
            ...
            if (!calendarHeatmap.in_transition) {
                ...
                calendarHeatmap.tooltip.html(t).style("left", r + "px").style("top", i +document.body.scrollTop + document.documentElement.scrollTop + "px").transition().duration(calendarHeatmap.settings.transition_duration / 2).ease(d3.easeLinear).style("opacity", 1)
            }
        }).on("mouseout", function() {
            calendarHeatmap.in_transition || calendarHeatmap.hideTooltip()
        }).transition().delay(function() {
    ...
    drawDayOverview: function() {
        ...
        calendarHeatmap.items.selectAll(".item-block").remove(), calendarHeatmap.items.selectAll(".item-block").data(calendarHeatmap.selected.details).enter().append("rect").attr("class", "item item-block").attr("x", function(a) {
            ...
            if (!calendarHeatmap.in_transition) {
                ...
                var r = this.getBoundingClientRect().top + calendarHeatmap.settings.tooltip_padding;
                calendarHeatmap.tooltip.html(e).style("left", n + "px").style("top", r + document.body.scrollTop + document.documentElement.scrollTop+ "px").transition().duration(calendarHeatmap.settings.transition_duration / 2).ease(d3.easeLinear).style("opacity", 1)
            }
        }).on("mouseout", function() {
            calendarHeatmap.in_transition || calendarHeatmap.hideTooltip()
        }).on("click", function(a) {
